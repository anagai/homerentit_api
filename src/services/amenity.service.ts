...
export default class AmenityService implements IAmenityService {
  ...
  constructor(
    ...
    async updateAmenity(amenity: Amenity): Promise<Amenity> {
    ...
    async removeAmenityById(id: string): Promise<Amenity> {
        return await this._dbAccess.delete<Amenity>(Tables.AMENITY, { id });
    }
}
